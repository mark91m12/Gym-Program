...
public class InsertForm extends JFrame {
	...
	public InsertForm() {
		...
		JInternalFrame panel_1 = new DisciplineSelectionPanel();
				...
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addContainerGap())
						.addComponent(panel_1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 540, GroupLayout.PREFERRED_SIZE)))
		);
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(57)
					.addComponent(list, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
